...
Sources used outside of udacity:
    ...
    Python documentation - time module - https://docs.python.org/3/library/time.html#module-time
    Time conversion - https://sqlpey.com/python/top-4-ways-to-convert-seconds-to-hhmmss-in-python/